use crate::apiclient;
use crate::protocol::saas_rs::user::v1::FindManyApiKeysRequest;
use clap::Parser;
use polars::prelude::*;
use std::io::Cursor;

pub const PS_COLUMNS: &[&str] = &["id", "description"];
