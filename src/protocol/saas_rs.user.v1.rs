...
pub struct Action {
    ...
    #[prost(oneof = "action::Owner", tags = "1006")]
    pub owner: ::core::option::Option<action::Owner>,
}
...
pub struct FindManyActionsRequest {
    ...
    #[prost(enumeration = "find_many_actions_request::Sort", optional, tag = "5")]
    pub sort: ::core::option::Option<i32>,
}
/// Nested message and enum types in `FindManyActionsRequest`.
pub mod find_many_actions_request {
    #[derive(
        Clone,
        Copy,
        Debug,
    ...
    impl Sort {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "NewestToOldest" => Some(Self::NewestToOldest),
                "OldestToNewest" => Some(Self::OldestToNewest),
                _ => None,
            }
        }
    }
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct FindManyActionsResponse {
    #[prost(message, repeated, tag = "1")]
...
pub mod user_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn find_action(
            &mut self,
            request: impl tonic::IntoRequest<super::FindActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FindActionResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("saas_rs.user.v1.User", "FindAction"));
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn find_many_actions(
            &mut self,
            request: impl tonic::IntoRequest<super::FindManyActionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FindManyActionsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("saas_rs.user.v1.User", "FindManyActions"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod user_server {
    ...
    pub trait User: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn find_action(
            &self,
            request: tonic::Request<super::FindActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FindActionResponse>,
            tonic::Status,
        >;
        ...
        async fn find_many_accounts(
            ...
            tonic::Status,
        >;
        async fn find_many_actions(
            &self,
            request: tonic::Request<super::FindManyActionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FindManyActionsResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/saas_rs.user.v1.User/FindAction" => {
                    #[allow(non_camel_case_types)]
                    struct FindActionSvc<T: User>(pub Arc<T>);
                    impl<T: User> tonic::server::UnaryService<super::FindActionRequest>
                    for FindActionSvc<T> {
                        type Response = super::FindActionResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as User>::find_action(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/saas_rs.user.v1.User/FindManyActions" => {
                    #[allow(non_camel_case_types)]
                    struct FindManyActionsSvc<T: User>(pub Arc<T>);
                    impl<
                        T: User,
                    > tonic::server::UnaryService<super::FindManyActionsRequest>
                    for FindManyActionsSvc<T> {
                        type Response = super::FindManyActionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as User>::find_many_actions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
